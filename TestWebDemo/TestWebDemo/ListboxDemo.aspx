<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ListboxDemo.aspx.vb" Inherits="TestWebDemo.ListboxDemo" MasterPageFile="~/test.Master" %>
        ...
        <tr>
            <td>
                ...
                <asp:ListBox ID="lstCountries" runat="server">
                    ...
                    <asp:ListItem Value="2">Shri Lanka</asp:ListItem>
                </asp:ListBox>
            </td>
            <td>
                2. Select` Fruit<br />
